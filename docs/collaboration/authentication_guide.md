...
// JWT 토큰 예시
const token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsImVtYWlsIjoibmF0dXJlLnBob3RvZ3JhcGhlckBleGFtcGxlLmNvbSIsImlhdCI6MTcyMzI4NDAwMCwiZXhwIjoxNzIzODg4ODAwfQ.signature";
